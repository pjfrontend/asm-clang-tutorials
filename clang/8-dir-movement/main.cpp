// https://learnsfml.com/concepts-patterns/movement/basic-eight-direction-movement/
#include <cmath>
#include <limits>
...
int main()
{
    sf::RenderWindow window(sf::VideoMode(1280, 720), "Example: Basic Eight Direction Movement");
